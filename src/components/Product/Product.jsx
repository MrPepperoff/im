            ...
            <div className="product__card">
                <div className="product__card--thumbnail">
                    ...
                    <ul className="product__card--action d-flex align-items-center justify-content-center">
                        <li className="product__card--action__list">
                            <a className="product__card--action__btn" title="Quick View" data-open="modal1" href="compare.html">
                ...
                <div className="product__card--content">
                    ...
                    <ul className="rating product__card--rating d-flex">
                        ...
                        <li>
                            <Rating myRating = {product.reviews}/>
                        </li>
                        <li>
                            <span className="rating__review--text">({product.reviews.count}) Review</span>
                        </li>
                        <li className="rating__all">
                            <span className="rating__icon">
                                <svg width="14" height="13" viewBox="0 0 14 13"  fill="currentColor" stroke="none" fillOpacity="1" strokeOpacity="1"  xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span className="rating__value">{product.reviews.average_value} </span>   
                        </li>
    
                        
                    </ul>
                    <h3 className="product__card--title"><Link to="/page/:id">{product.title}</Link></h3>
